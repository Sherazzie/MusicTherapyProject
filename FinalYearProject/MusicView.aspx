...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <asp:DataList ID="dl_music" runat="server" Font-Names="Verdana" Font-Size="Small" RepeatColumns="3" RepeatDirection="Horizontal" Width="600px" HorizontalAlign="Center">
                ...
                <ul id="plans">
                    <li class="plan">
                        <ul class="planContainer">
                            ...
                            <li class="button"><a id="btn_getsongs" runat="server" href="UploadMusic.aspx" onclick="load_songs"> Songs</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
